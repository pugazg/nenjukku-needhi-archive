...
| `v1-ch07` | `"நீங்களா 'மாணவ நேசன்' நடத்துகிறீர்கள்?"` | 51–55 | **THOUGHT STRUCTURE COMPLETE / TERMINOLOGY NEXT** |
...
Run the **terminology/cultural-consistency audit for `v1-ch07`**. Review publication titles and forms, political proper names and honorific variation, `Maanava Nesan`, `Murasoli`, **handwritten journal / copy**, **Pongal special issue**, **demy paper**, **leaflet issues**, **organizing camp** for `பாசறை`, the generic **Students' Federation**, **Freedom – Peace – Equality**, and chapter-level romanisation/cultural consistency. Do not consult any existing-English comparator yet.
